var jStks=localStorage.getItem("jStks");jStks=JSON.parse(jStks);var bdw,bdh,moX,moY,nmoX,nmoY,wrp="#mainWrap",wso=".wasOn",fls=0;function onjStk(t,s){s?$(wso).removeClass("onjStk wasOn"):$(".onjStk").removeClass("onjStk"),$(t).addClass("onjStk wasOn"),$("#rMenu").remove()}function addjStk(t,s){var e='<div class="jStickers" id="'+t+'" bClr="'+s.bClr+'" fClr="'+s.fClr+'" fSz="'+s.fSz+'" spr="'+s.spr+'" style="width:'+s.w+"px;height:"+s.h+"px;top:"+s.t+"px;left:"+s.l+"px;z-index:"+s.z+';display:none;">        <div class="jStkBar">            <h5 class="jStkXY">'+s.data+'</h5>            <div class="jStkBtns">                <span class="jStkBtn tBtn" onclick="fldjStk(\''+t+'\')" title="메모 접기&amp;펴기"></span>                <span class="jStkBtn xBtn" onclick="removejStk(\''+t+'\')" title="메모 닫기">X</span>            </div>        </div>        <textarea class="jStkText">'+s.data+'</textarea>        <div class="sizeArea"></div>    </div>';e=$(e),$(wrp).append(e),e.fadeIn()}
...
An}();typeof define=="function"&&typeof define.amd=="object"&&define.amd?(Fn._=rt, define(function(){return rt})):Pn?((Pn.exports=rt)._=rt,Nn._=rt):Fn._=rt}).call(this);function newjStk(){var t=["p","a","r","k","t","o","p"],s=250+moX>bdw?moX-250-10:moX,e=200+moY>bdh?moY-200-10:moY;t=t[_.random(6)]+t[_.random(6)]+_.now(),jStks[t]={bClr:1,fClr:6,fSz:2,w:250,h:200,t:e,l:s,z:2,spr:!0,date:_.now(),data:"",id:t},addjStk(t,jStks[t]),setdata(),_.delay(function(t){$("#"+t+" .jStkText").trigger("mousedown").trigger("focus")},100,t)}function fldjStk(t){$("#"+t+" .jStkText").toggle(50,function(){$("#"+t).attr("spr",$(this).is(":visible")),setVal(t+".spr",$(this).is(":visible"),!0)}),onjStk($("#"+t),!0)}function jStkXY(t,s,e,n){t=$(t),n||(s=_.parseInt(t.css("left"))+s,e=_.parseInt(t.css("top"))+e),s<5&&(s=10),s+t.width()>bdw&&(s=bdw-t.width()-10),e<5&&(e=10),e+t.height()>bdh&&(e=bdh-t.height()-10),t.css({top:e,left:s}),setVal((t=t.attr("id"))+".l",s),setVal(t+".t",e),n&&setdata()}function jStkWH(t,s,e,n){t=$(t);var i=_.parseInt(t.css("left")),o=_.parseInt(t.css("top"));n||(s=t.width()+s,e=t.height()+e),s<250&&(s=250),s+i>bdw&&(s=bdw-i-10),e<30&&(e=30),e+o>bdh&&(e=bdh-o-10),t.height(e).width(s),setVal((t=t.attr("id"))+".w",s),setVal(t+".h",e),n&&setdata()}/*** @license* Lodash lodash.com/license | Underscore.js 1.8.3 underscorejs.org/LICENSE*/function rMenuOp(){obj=$(event.target),$("#rMenu").remove();var t="";if("mainWrap"==obj.attr("id"))t+='        <div class="rItemGrp">            <h4 class="rItem stPrpg" onmouseup="newjStk()">메모 추가</h4>        </div>        <div class="rItemGrp">            <h4 class="rItem stPrpg" onmouseup="jStkAlign(\'bClr\')">메모 색 별 정렬</h4>            <h4 class="rItem stPrpg" onmouseup="jStkAlign(\'date\')">메모 시간순 정렬</h4>        </div>        <div class="rItemGrp">',$(wso).length>1&&(t+='<h4 class="rItem stPrpg" onmouseup="removeWso()">선택 메모 닫기</h4>'),t+='<h4 class="rItem stPrpg" onmouseup="removeAlljStk()">메모 전부 닫기</h4>        </div>';else{if(!obj.parents(".jStickers").hasClass("jStickers")&&!obj.hasClass("jStickers"))return!1;obj=obj.hasClass("jStickers")?obj:obj.parents(".jStickers"),onjStk(obj);var s="true"==obj.attr("spr")?"접기":"펼치기";for(t='        <div class="rItemGrp">            <h4 class="rItemTtl">서식 조정 기능</h4>            <div class="rItemOtn setbClr">                <span>배경 색상 변경</span> <input class="colorPik inps" bClr="'+obj.attr("bClr")+'"/>            </div>            <div class="rItemOtn setfClr">                <span>글자 색상 변경</span> <input class="colorPik inps" bClr="'+obj.attr("fClr")+'"/>            </div>            <div class="rItemOtn">                <span>글자 크기 선택</span>                <select class="ftSize inps" onchange="setjStkOp(\'fSz\',this.value)">',i=1;i<=6;i++){var e=obj.attr("fSz")==i?"selected":"";t+='<option value="'+i+'" '+e+">1"+i+"</option>"}t+='</select>            </div>        </div>        <div class="rItemGrp">            <h4 class="rItem stPrpg" onmouseup="fldjStk(\''+obj.attr("id")+"')\">"+s+'</h4>        </div>        <div class="rItemGrp">            <h4 class="rItem removeDly">                <input id="setScd" class="inps" type="number" min="1" value="10" onkeyup="isEnt()">                <span onmouseup="setDly()" class="stPrpg">초 후 닫기</span>            </h4>            <h4 class="rItem stPrpg" onmouseup="removejStk(\''+obj.attr("id")+"');\">메모 닫기</h4>        </div>",_.delay(callclrpik,500,5),_.delay(callclrpik,500,7)}$(wrp).append('<div id="rMenu">'+t+"</div>");var n=$("#rMenu").width()+moX>bdw?moX-$("#rMenu").width()-10:moX;s=$("#rMenu").height()+moY>bdh?moY-$("#rMenu").height()-10:moY;$("#rMenu").css({top:s,left:n})}function callclrpik(t){var s=["노란색","연보라색","초록색","남색","주황색","검은색","흰색"],e=t>6?"f":"b";for($(".set"+e+"Clr").append('<div class="colorPicker"></div>'),i=1;i<=t;i++){var n=i%2==0?7:6;$(".set"+e+"Clr .colorPicker").append('<div bClr="'+i+'" fClr="'+n+'" onclick="setjStkOp(\''+e+"Clr',"+i+')" oncontextmenu="setjStkOp(\''+e+"Clr',"+i+')">'+s[i-1]+"</div>")}}function setjStkOp(t,s){$(".onjStk").attr(t,s),$(".set"+t+" input").attr("bClr",s).blur(),setVal($(".onjStk").attr("id")+"."+t,s),localStorage.setItem("jStks",JSON.stringify(jStks))}function isEnt(){"Enter"==event.key&&setDly()}function jStkAlign(t){var s=_.sortBy(jStks,t);_.forEach(s,function(t){$("#"+t.id).appendTo(wrp)}),$(".jStickers").addClass("jSalign").width(250).height(200).attr("spr","true"),jStks={},_.transform(s,function(t,s,e){e=$("#"+s.id).position(),jStks[s.id]=s,jStks[s.id].w=250,jStks[s.id].h=200,jStks[s.id].t=e.top+10,jStks[s.id].l=e.left+10,jStks[s.id].spr=!0,$("#"+s.id).css({top:e.top+10,left:e.left+10})}),$(".jStickers").removeClass("jSalign"),$(".jStkText").show(),$(wso).removeClass("onjStk wasOn"),setdata()}function removejStk(t){$("#"+t).fadeOut(function(){$(this).remove()}),_.unset(jStks,t),setdata(),_.isEmpty(jStks)&&$(wrp).append('<div id="newArea" class="stPrpg" onmouseup="newjStk();$(this).remove();" onmouseover="$(this).html(\'😸\')" onmouseout="$(this).html(\'😿\')">😸</div>')}function setDly(){$(".onjStk .jStkXY .timr").hasClass("timr")?($(".onjStk .jStkXY .timr").remove(),_.delay(function(t){$(t[0]).find(".jStkXY").prepend('<span class="timr">'+t[1]+"</span>"),removeDly($(t[0]))},1010,[$(".onjStk"),parseInt($("#setScd").val())+1])):($(".onjStk .jStkXY").prepend('<span class="timr">'+(parseInt($("#setScd").val())+1)+"</span>"),removeDly($(".onjStk"))),$("#rMenu").remove()}function removeDly(t){t=$(t);var s=parseInt(t.find(".timr").html());if(s>0)t.find(".timr").html(s-1),_.delay(removeDly,1e3,t);else{if(0!=s)return!1;removejStk(t.attr("id"))}}function removeWso(){confirm("선택된 메모를 닫을까요?")&&$(wso).each(function(){removejStk($(this).attr("id"))})}function removeAlljStk(){confirm("메모를 전부 닫을까요?")&&(jStks={},$(".jStickers").fadeOut(function(){$(this).remove()}),setdata(),$(wrp).append('<div id="newArea" onclick="newjStk();$(this).remove();" onmouseover="$(this).html(\'😸\')" onmouseout="$(this).html(\'😿\')">😸</div>'))}function setVal(t,s,e){_.set(jStks,t,s),e&&setdata()}function setdata(){localStorage.setItem("jStks",JSON.stringify(jStks)),$("#rMenu").remove()}$(document).ready(function(){bdw=$(wrp).width(),bdh=$(wrp).height(),$(wrp).on({click:function(){$(wso).removeClass("onjStk wasOn"),$("#rMenu").remove()},contextmenu:function(t){t.preventDefault(),0===fls&&(_.isEmpty(jStks)?newjStk():rMenuOp()),fls=0},mousemove:function(t){nmoX=moX-t.clientX,nmoY=moY-t.clientY,moX=t.clientX,moY=t.clientY,fls>0&&$(wso).each(function(){2==fls&&jStkWH($(this),-1*nmoX,-1*nmoY),3==fls&&jStkXY($(this),-1*nmoX,-1*nmoY)})},mouseup:function(t){fls>0&&(fls=0,setdata()),$(t.target).hasClass("stPrpg")&&(fls=5)}}).on({click:function(t){t.stopPropagation()},mousedown:function(){onjStk(this)}},".jStickers").on({mousedown:function(t){onjStk($(this).parents(".jStickers"),!0)},keyup:function(t){setVal($(".onjStk").attr("id")+".data",this.value,!0),$(this).siblings(".jStkBar").children(".jStkXY").html(this.value)}},".jStkText").on("mousedown",".jStkXY",function(t){fls=3}).on("mousedown",".sizeArea",function(t){fls=2}).on("click contextmenu mouseup mousedown","#rMenu, .colorPicker",function(t){$(t.target).hasClass("inps")||t.preventDefault(),t.stopPropagation()}),_.isEmpty(jStks)?($(wrp).append('<div id="newArea" class="stPrpg" onmouseup="newjStk();$(this).remove();">📝 화면을 클릭하고 메모를 시작하세요!</div>'),jStks={}):_.forEach(jStks,function(t,s){addjStk(s,t)})}),$(window).resize(function(){bdw=$(wrp).width(),bdh=$(wrp).height();var t=["w","l","h","t"],s=[];$(".jStickers").each(function(){var e=0;if(s[0]=$(this).width(),s[1]=parseInt($(this).css("left")),s[2]=$(this).height(),s[3]=parseInt($(this).css("top")),s[0]+s[1]+20>bdw&&(e=bdw-(s[0]+s[1]+20),s[0]>s[1]?s[0]=s[0]+e:s[1]=s[1]+e),s[2]+s[3]+20>bdh&&(e=bdh-(s[3]+s[2]+20),s[2]>s[3]?s[2]=s[2]+e:s[3]=s[3]+e),0==!e){$(this).width(s[0]).height(s[2]).css({top:s[3]+"px",left:s[1]+"px"});for(var n in t)setVal($(this).attr("id")+"."+t[n],s[n])}}),s.length>1&&setdata()});